...
LENX = 1550  # mm. LENGTH IN X
LENY = 1225  # mm. LENGTH IN Y
NPADX = 12  # NUM. OF CELLS IN X (COLUMNS)
NPADY = 10  # NUM. OF CELLS IN Y (ROWS)

# CLUNKY
WCX = LENX / NPADX  # mm. CELL WIDTH IN X (TOTAL)
WCY = LENY / NPADY  # mm. CELL WIDTH IN Y (TOTAL)

# EXACT
SEP = 10  # mm. SEPARATION AMONG PADS
EDGEX = 19  # mm. DETECTOR EDGE IN X
EDGEY = 7.5  # mm. DETECTOR EDGE IN Y
PITCHX = (LENX - 2 * EDGEX) / NPADX  # mm. PITCH WIDTH IN X
PITCHY = (LENY - 2 * EDGEY) / NPADY  # mm. PITCH WIDTH IN Y
WPADX = PITCHX - SEP  # mm. ACTIVE WIDTH IN X
WPADY = PITCHY - SEP  # mm. ACTIVE WIDTH IN Y
